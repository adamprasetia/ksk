...
<div class="box box-default">
	...
	<div class="box-body">
		<?php echo form_open($action,array('class'=>'form-inline'))?>
			...
			<div class="form-group">
				<?php echo form_dropdown('group',$this->komponen_mdl->dropdown_group(),$this->input->get('group'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
			<div class="form-group">
				<?php echo form_dropdown('satuan',$this->komponen_mdl->dropdown_satuan(),$this->input->get('satuan'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
		<?php echo form_close()?>
