<div class="panel panel-default">
	...
	<div class="panel-body">
		<?=form_open($action,array('class'=>'form-inline'))?>
			...
			<div class="form-group">
				<?=form_dropdown('group',$this->komponen_mdl->komponen_group_dropdown(),$this->input->get('group'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
			<div class="form-group">
				<?=form_dropdown('satuan',$this->komponen_mdl->komponen_satuan_dropdown(),$this->input->get('satuan'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
		<?=form_close()?>
