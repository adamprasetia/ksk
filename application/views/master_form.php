<section class="content-header">
	...
	<ol class="breadcrumb">
	    ...
	    <li><?php echo anchor($breadcrumb,'List Data')?></li>
...
<div class="box box-default">
	...
	<div class="box-body">
		...
		<div class="form-group form-inline">
			...
			<?php echo form_input(array('name'=>'nama','class'=>'form-control input-sm','maxlength'=>'50','size'=>'50','autocomplete'=>'off','value'=>set_value('nama',(isset($row->nama)?$row->nama:'')),'required'=>'required'))?>
