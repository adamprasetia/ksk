...
<div class="box box-default">
	...
	<div class="box-body">
		<?php echo form_open($action,array('class'=>'form-inline'))?>
			...
			<div class="form-group">
				<?php echo form_dropdown('tipe',$this->servis_mdl->dropdown_tipe(),$this->input->get('tipe'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
			<div class="form-group">
				<?php echo form_dropdown('kendaraan',$this->kendaraan_mdl->dropdown(),$this->input->get('kendaraan'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
		<?php echo form_close()?>
