<tr>
	<td>
		<?=form_dropdown('komponen[]',$this->komponen_mdl->komponen_dropdown(),set_value('komponen[]',''),'required=required class="form-control input-sm"')?>
	...
	<td><?=form_dropdown('aksi[]',$this->komponen_mdl->komponen_aksi_dropdown(),set_value('aksi[]',''),'required=required class="form-control input-sm"')?></td>
