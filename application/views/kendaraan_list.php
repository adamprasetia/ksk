<div class="panel panel-default">
	...
	<div class="panel-body">
		<?=form_open($action,array('class'=>'form-inline'))?>
			...
			<div class="form-group">
				<?=form_dropdown('tipe',$this->kendaraan_mdl->kendaraan_tipe_dropdown(),$this->input->get('tipe'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
			<div class="form-group">
				<?=form_dropdown('status',$this->kendaraan_mdl->kendaraan_status_dropdown(),$this->input->get('status'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
		<?=form_close()?>
