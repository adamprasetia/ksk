...
INSERT INTO `komponen` (`id`, `nama`, `group`, `harga`, `satuan`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	...
	(27, 'Lainnya', 4, 0, 3, 'damz', '2015-11-01 12:37:37', '', '0000-00-00 00:00:00');
...
-- Dumping data for table kartu_sehat_kendaraan.komponen_satuan: ~3 rows (approximately)
...
-- Dumping data for table kartu_sehat_kendaraan.servis: ~11 rows (approximately)
...
INSERT INTO `servis` (`id`, `nomor`, `kendaraan`, `tanggal`, `tipe`, `kilometer`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	...
	(8, '008', 2, '2015-11-01', 2, '8', 'damz', '2015-11-01 14:19:21', 'damz', '2015-11-22 09:24:17'),
	(9, '009', 2, '2015-11-04', 1, '99999', 'damz', '2015-11-04 23:05:31', '', '0000-00-00 00:00:00'),
	(10, '1231232', 1, '2015-09-15', 1, '123232323', 'damz', '2015-11-21 17:17:03', 'damz', '2015-11-22 09:29:36'),
	(11, '123232323', 3, '2015-06-16', 1, '12323232323', 'damz', '2015-11-22 09:38:01', '', '0000-00-00 00:00:00'),
	(12, 'asdsd', 3, '2015-11-17', 1, '1232323', 'damz', '2015-11-22 09:56:17', '', '0000-00-00 00:00:00');
...
-- Dumping data for table kartu_sehat_kendaraan.servis_detail: ~20 rows (approximately)
...
INSERT INTO `user_level` (`id`, `name`, `date_create`) VALUES
	(1, 'Admin Bidang KJL', '2015-10-31 13:59:44'),
	(2, 'Admin Bendahara Barang', '2015-10-31 13:59:44');
